...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "test_prj01@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "test_prj01 API";

        private String description = "test_prj01 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "test_prj01";
